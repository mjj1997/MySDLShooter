...
// configuration step. It creates a namespace called `MySDLShooter`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", MySDLShooter::cmake::project_name, MySDLShooter::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", MySDLShooter::cmake::project_version);
      return EXIT_SUCCESS;
    }
